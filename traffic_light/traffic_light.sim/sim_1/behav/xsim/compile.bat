...
REM
REM Generated by Vivado on Tue Oct 28 13:26:15 +0900 2025
...
echo "xvlog --incr --relax -prj traffic_light_fsm_vlog.prj"
call xvlog  --incr --relax -prj traffic_light_fsm_vlog.prj -log xvlog.log
