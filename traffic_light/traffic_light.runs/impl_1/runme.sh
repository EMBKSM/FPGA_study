...
HD_PWD='C:/work/github/FPGA_study/traffic_light/traffic_light.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_light_fsm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traffic_light_fsm.tcl -notrace
