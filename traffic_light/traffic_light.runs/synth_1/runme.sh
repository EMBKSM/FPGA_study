...
HD_PWD='C:/work/github/FPGA_study/traffic_light/traffic_light.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_light_fsm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic_light_fsm.tcl
