namespace eval ::optrace {
  variable script "C:/work/github/FPGA_study/UART/UART.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/work/github/FPGA_study/UART/UART.cache/wt [current_project]
  set_property parent.project_path C:/work/github/FPGA_study/UART/UART.xpr [current_project]
  set_property ip_output_repo C:/work/github/FPGA_study/UART/UART.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/work/github/FPGA_study/UART/UART.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/work/github/FPGA_study/UART/UART.srcs/sources_1/bd/design_1/design_1.bd
