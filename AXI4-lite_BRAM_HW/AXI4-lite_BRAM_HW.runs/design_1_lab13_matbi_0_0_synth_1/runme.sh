...
HD_PWD='C:/work/github/FPGA_study/AXI4-lite_BRAM_HW/AXI4-lite_BRAM_HW.runs/design_1_lab13_matbi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_lab13_matbi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_lab13_matbi_0_0.tcl
